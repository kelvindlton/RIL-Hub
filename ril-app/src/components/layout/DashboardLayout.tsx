                    ...
                    notifications.map(notif => (
                      ...
                      >
                        ...
                        <div className="shrink-0 mt-0.5">
                          {notif.avatar ? (
                            <img src={notif.avatar} alt="" className="w-8 h-8 rounded-full border border-gray-100" />
                          ) : (
                  ...
                  {memberResults.length > 0 && (
                    <div className="px-2 pb-2">
                      ...
                      {memberResults.map((p) => (
                        ...
                        >
                          <img src={p.avatar} alt={p.name} className="w-8 h-8 rounded-full border border-gray-100 shrink-0" />
